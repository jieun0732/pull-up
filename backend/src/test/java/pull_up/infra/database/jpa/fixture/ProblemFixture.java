...
public enum ProblemFixture implements Fixture<Problem>{
    MATH_VELOCITY_1(1L, 0, 0, 0D, MATH, "속력", "철수가 출발 지점에서 10km 떨어진 지점에서부터 시계 방향으로 원형 트랙을 자전거로 돌기 시작했다. 이 원형 트랙의 총 길이는 8km이다. 철수는 처음 2시간 동안 5바퀴를 돌았고, 다음 1시간 동안 3바퀴를 돌았다면, 철수의 3시간 동안의 자전거 평균 속력은 몇 km/h인가? (소수점 둘째자리에서 반올림하세요.)".getBytes(UTF_8), "".getBytes(UTF_8), "18.2 km/h", "20.5 km/h", "21.3 km/h", "28.7 km/h", "30.1 km/h", "3", "자전거로 총 달린 거리를 구합니다. 첫 2시간 동안: 8km X 5바퀴 = 40km 다음 1시간 동안: 8km X 3바퀴 = 24km 따라서, 총 3시간 동안 달린 거리는 40 + 24 = 64km입니다. 평균 속력은 총 이동 거리(64km)를 총 시간(3시간)으로 나눈 값입니다. 즉, 64 / 3 = 약 21.33 km/h입니다. 하지만 이 값은 소수점 첫째 자리를 올림하여 21.3km/h가 됩니다.".getBytes(UTF_8)),
    MATH_VELOCITY_2(2L, 0, 0, 0D, MATH, "속력", "민수는 원형 트랙을 자전거로 시계 방향으로 돌면서 첫 30분 동안 4바퀴, 그 다음 30분 동안 5바퀴, 마지막 1시간 동안 10바퀴를 돌았다. 원형 트랙의 총 길이가 6km라면, 민수가 2시간 동안 자전거를 탄 평균 속력은 몇 km/h인가?".getBytes(UTF_8), "".getBytes(UTF_8), "48 km/h", "57 km/h", "60 km/h", "66 km/h", "78 km/h", "2", "민수가 자전거로 총 달린 거리를 구합니다. 첫 30분 동안: 6km X 4바퀴 = 24km 다음 30분 동안: 6km X 5바퀴 = 30km 마지막 1시간 동안: 6km X 10바퀴 = 60km 따라서 총 이동 거리는 24 + 30 + 60 = 114km입니다. 평균 속력은 총 이동 거리(114km)를 총 시간(2시간)으로 나눈 값입니다. 즉, 114 / 2 = 57 km/h 입니다.".getBytes(UTF_8)),
    MATH_DENSITY_1(3L, 0, 0, 0D, MATH, "용액의 농도", "어떤 소금물 500g에 100g 물을 증발시켰더니 15%의 소금물이 되었다. 처음 소금물의 농도는 몇 %인가?".getBytes(UTF_8), "".getBytes(UTF_8), "10%", "12%", "13%", "14%", "16%", "2", "초기 소금물의 농도는 미지수 x로 두고, 최종 농도는 15%이며, 초기 무게는 500g이고 최종 무게는 400g입니다. 이를 대입하여 초기 농도를 구해봅시다. 초기 농도 x 초기 무게 = 최종 농도 x 최종 무게 x * 500g = 15% * 400g 500x = 0.15 * 400 500x = 60 x = 60 / 500 x = 0.12 또는 12% 따라서 처음 소금물의 농도는 12%입니다.".getBytes(UTF_8)),
    MATH_DENSITY_2(4L, 0, 0, 0D, MATH, "용액의 농도", "어떤 소금물 600g에 300g 물을 증발시켰더니 20%의 소금물이 나왔다. 처음 소금물의 농도는 몇 %인가?".getBytes(UTF_8), "".getBytes(UTF_8), "10%", "16%", "17%", "18%", "20%", "1", "초기 소금물의 농도는 미지수 x로 두고, 최종 농도는 20%이며, 초기 무게는 600g이고 최종 무게는 300g입니다. 이를 대입하여 초기 농도를 구해봅시다. 초기 농도 x 초기 무게 = 최종 농도 x 최종 무게 x * 600g = 20% * 300g 600x = 0.20 * 300 600x = 60 x = 60 / 600 x = 0.10 또는 10% 따라서 처음 소금물의 농도는 10%입니다.".getBytes(UTF_8)),
    ...
    public Problem get() {
        String questionSummary = new String(question);
        return new Problem(id, totalAttempts, incorrectAttempts, incorrectRate, entry, problemType, question, questionSummary.length() <= 100? questionSummary : questionSummary.substring(0, 100), example, choice1, choice2, choice3, choice4, choice5, correctAnswer, explanation);
    }
}