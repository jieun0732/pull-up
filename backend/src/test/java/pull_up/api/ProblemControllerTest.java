...
class ProblemControllerTest {
    ...
    void testAllAPI() throws Exception {
        Create.Request request = new Create.Request(Entry.MATH, "problemType", "question", "explanation", "choice1", "choice2", "choice3", "choice4", "choice5", "answer", "answerExplanation");
