...
public class ExamController {
    ...
    @Operation(summary = "문제 조회(골고루 및 유형별)", description = "MemberAnswer의 id를 이용하여 문제를 조회합니다.", tags = "Deprecated")
    @GetMapping("/problem")
    ...
    @Operation(summary = "수리 문제 요약 조회", description = "회원이 저장한 답안에 대한 수리 문제 요약을 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "언어 문제 요약 조회", description = "회원이 저장한 답안에 대한 언어 문제 요약을 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "추리 문제 요약 조회", description = "회원이 저장한 답안에 대한 추리 문제 요약을 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "문제 정답 여부 및 선택된 답안 조회", description = "회원이 저장한 답안에 대한 문제의 정답 여부와 선택된 답안을 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "다시 풀기", description = "회원의 문제 답안을 초기화합니다.", tags = "Deprecated")
    @PutMapping("/reset")
    ...
    @Operation(summary = "이어 풀기", description = "회원이 아직 풀지 않은 문제를 조회합니다.", tags = "Deprecated")
    @GetMapping("/next")
    ...
    @Operation(summary = "모의고사 문제 푼 여부 조회", description = "시험 정보 ID를 기준으로 문제와 푼 여부를 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "모의고사 id로 문제 리스트 및 정답 여부 조회 ", description = "시험 정보 ID를 기준으로 문제를 조회합니다.", tags = "Deprecated")
     ...
     */
    @Operation(summary = "모의고사 문제 하나 조회(모의고사Id + 문제 번호 이용)", description = "모의고사 문제 하나를 조회합니다.", tags = "Deprecated")
    ...
    @Operation(summary = "최근 모의고사 정보 및 문제 유형별 결과", description = "멤버의 가장 최근 모의고사 정보를 반환합니다. 수정", tags = "Deprecated")
