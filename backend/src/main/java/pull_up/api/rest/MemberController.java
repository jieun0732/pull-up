...
public class MemberController {
    ...
    @Operation(summary = "[골고루, 유형별] 틀린문제 조회", description = "사용자의 틀린문제를 조회합니다.", tags = "멤버")
    ...
    @Operation(summary = "튜토리얼 체크", description = "사용자의 튜토리얼 현황을 완료로 변경합니다.", tags = "멤버")
    ...
    @Operation(summary = "회원탈퇴", description = "사용자를 삭제합니다. 모의고사 정보는 삭제되지 않습니다.", tags = "멤버")
    @DeleteMapping("/{memberId}")
    public ResponseEntity<MessageDto> delete(@PathVariable Long memberId) {
        return new ResponseEntity<>(memberService.delete(memberId), HttpStatus.OK);
    }
}
